...
export default function RecentRentSlider() {
    ...
    return (
        <section className="relative w-full py-16">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
                {t("RecentRentTitle") || "Recent Properties for Rent"}
            </h2>
            <p className="mb-10 text-center text-xl text-slate-400">{t('RecentRentDesc') || 'Nulla quis curabitur velit volutpat auctor bibendum consectetur sit.'}</p>
